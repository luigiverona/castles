...
The bootstrap downloads only the version-pinned 0.1.4 wheel from the official GitHub release,
...
verifying it against `castles-0.1.4-SHA256SUMS.txt` from the same release:

```bash
uv tool install https://github.com/luigiverona/castles/releases/download/v0.1.4/castles-0.1.4-py3-none-any.whl
castles --version
```
